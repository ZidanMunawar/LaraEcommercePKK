    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center mb-3">
                <h5 class="mb-0">Daftar Warna</h5>
                <div class="ms-auto position-relative">
                    <div class="position-absolute top-50 translate-middle-y search-icon px-3">
                        <ion-icon name="search-sharp"></ion-icon>
                    </div>
                    <input class="form-control ps-5" type="text" id="searchInput" placeholder="Cari warna...">
                </div>
            </div>
                    ...
                    <tbody id="colorsTable">
                        @forelse($colors as $index => $color)
                            <tr>
                                ...
                                <td>
                                    <div
                                        style="width: 40px; height: 40px; background-color: {{ $color->code }}; border: 2px solid #dee2e6; border-radius: 4px;">
                                    </div>
                                </td>
                                <td><small style="opacity: 0.7;">{{ $color->created_at->format('d M Y, H:i') }}</small></td>
                                <td><small style="opacity: 0.7;">{{ $color->updated_at->format('d M Y, H:i') }}</small></td>
                        ...
                        @empty
                            <tr id="emptyRow">
                                <td colspan="7" class="text-center py-5">
                                    <ion-icon name="color-palette-outline" style="font-size: 64px; color: #ccc;"></ion-icon>
                                    <p class="text-muted mt-3 mb-0">Belum ada data warna</p>
